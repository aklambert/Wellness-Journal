...
class WeightTrackingViewModel(application: Application) : AndroidViewModel(application) {
    // Get goalweight dao
    ...
    fun isThereAGoalWeight(): Boolean {
        //val listGoalWeight = weightRepository.listGoalWeight
