...
## Schedule & Milestones
This project began in late January and was given a deadline of May 2, 2024 to meet a certain set of requirements for an initial version. There was a schedule with milestones set at the beginning, and there were 2 additional schedule modifications later. See the `Projects & Milestones` Wiki page to see the schedule details.

## Project Requirements
[Wellness Journal V1 Requirements.pdf](https://github.com/user-attachments/files/16765418/Wellness.Journal.V1.Requirements.pdf)


## Database Design
[Wellness Journal V1 ER Diagram.pdf](https://github.com/user-attachments/files/16765442/Wellness.Journal.V1.ER.Diagram.pdf)

## Manuals
[Wellness Journal V1 Technical and User Manuals.pdf](https://github.com/user-attachments/files/16765513/Wellness.Journal.V1.Technical.and.User.Manuals.pdf)
